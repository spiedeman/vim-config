...
[core]
s0_active_plugins = core;composite;opengl;imgpng;snap;place;grid;session;compiztoolbox;vpswitch;move;unitymtgrabhandles;commands;copytex;regex;shift;mousepoll;animation;resize;fade;expo;workarounds;ezoom;scale;unityshell;
